...
import '../styles/lifeAfterSports.css';

export default function LifeAfterSports() {
    return (
        <div className="life-after-sports-page">
            <header>
                <h1>Welcome to the Life After Sports Page</h1>
                <nav>
                    <ul>
                        <li><a href="/">Home</a></li>
